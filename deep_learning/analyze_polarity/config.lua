...
config.val_data.file =  paths.concat(paths.cwd(), "../data/data_dazhongdianping/test_polarity_environment.t7b")
...
config.main.save = '../train_dianping/polarity_environment'--paths.concat(paths.cwd())
