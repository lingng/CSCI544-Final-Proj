...
-- Training data
config.train_data = {}
config.train_data.file = paths.concat(paths.cwd(), "../data/data_dazhongdianping/train_polarity_service.t7b")
...
-- Validation data
config.val_data = {}
config.val_data.file =  paths.concat(paths.cwd(), "../data/data_dazhongdianping/validate_polarity_service.t7b")
...
config.main.save = 'polarity_service'
